...
class ProductIndumentariaService extends ChangeNotifier {
  final String _baseUrl = 'smiley-appi.herokuapp.com';
  List<Product> products = [];
  late Product selectedProduct;
  bool isLoading = true;
  ...
  Future<List<Product>> loadProducts() async {
    isLoading = true;
    final url = Uri.https(_baseUrl, '/api/products/indumentaria');
    final resp = await http.get(url);
...
class ProductCursosService extends ChangeNotifier {
  final String _baseUrl = 'smiley-appi.herokuapp.com';
  List<Product> products = [];
  late Product selectedProduct;
  bool isLoading = true;
  ...
  Future<List<Product>> loadProducts() async {
    isLoading = true;
    final url = Uri.https(_baseUrl, '/api/products/cursos');
    final resp = await http.get(url);
