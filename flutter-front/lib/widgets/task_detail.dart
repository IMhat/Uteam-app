...
class _TaskDetails extends StatefulWidget {
  ...
  const _TaskDetails({this.title, this.subTitle, this.type, this.points});
            ...
            children: [
              ...
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Image(
                          image: AssetImage("assets/tareaasignada.jpg")),
                      Container(
                        width: 150,
                        height: 45,
                        child: Column(
              ...
              Row(
                ...
                children: [
                  Container(color: Colors.white, child: MyButtonAcept()),
                  Container(
                    color: Colors.white,
                    child: ElevatedButton(
