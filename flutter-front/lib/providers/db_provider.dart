...
//   //
//   Future<int> nuevaPoint(PointModel nuevaPoint) async {
//     final db = await database;
//     final res = await db!.insert('Points', nuevaPoint.toJson(),
//         conflictAlgorithm: ConflictAlgorithm.replace);
//     print(res);
//     // Es el ID del último registro insertado;
//     return res;
...
//     return response.isNotEmpty ? PointModel.fromJson(response.first) : null;
//   }
...
//   //
//   Future<List<PointModel>> getTodasLasPoints() async {
//     final db = await database;
//     final res = await db!.query('Points');

//     return res.isNotEmpty
//         ? res.map((t) => PointModel.fromJson(t)).toList()
//         : [];
//   }
...
//   //
//   //
//   Future<String?> updatePoint(PointModel nuevaPoint) async {
//     final db = await database;
//     final res = await db!.update('Points', nuevaPoint.toJson(),
//         where: 'id = ?', whereArgs: [nuevaPoint.id]);
//     return res.toString();
//   }
...
//     final db = await database;
//     final res = await db!.delete('Points', where: 'id = ?', whereArgs: [id]);
//     return res;
//   }
